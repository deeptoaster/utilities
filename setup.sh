#!/bin/bash
sudo apt --auto-remove purge file-roller gigolo gmusicbrowser gnome-mines gnome-sudoku libreoffice-* mousepad mugshot parole ristretto software-center thunar-volman xfce4-notes xfce4-whiskermenu-plugin
