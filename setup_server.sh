...
sudo apt install apache2 black doxygen git-ftp inotify-tools npm pandoc php php-bcmath php-curl php-gd php-sqlite3 php-xml pipx python3-pip python3-venv
