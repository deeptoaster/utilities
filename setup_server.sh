...
sudo apt install apache2 black git-ftp inotify-tools npm pandoc php php-bcmath php-curl php-gd php-sqlite3 php-xml python3-pip python3-venv vim-ale vim-ctrlp vim-gitgutter
